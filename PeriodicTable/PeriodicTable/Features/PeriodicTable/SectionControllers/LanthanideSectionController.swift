//
//  LanthanideSectionController.swift
//  PeriodicTable
//
...
final class LanthanideSectionController: ListSectionController {
    ...
    override func cellForItem(at index: Int) -> UICollectionViewCell {
        ...
        cell.layer.borderColor = UIColor.elementPurple.cgColor
        cell.layer.borderWidth = 1
        cell.backgroundColor = .elementPurple.withAlphaComponent(0.5)
